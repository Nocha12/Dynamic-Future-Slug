...
namespace RGEngine
{
	...
	{
		AnimationRenderer::AnimationRenderer(GameObject *gameObject) : Renderer(gameObject), loop(true), pause(false), startFrame(0.0f), endFrame(0.0f), nowFrame(0.0f), speed(1.0f) {}
